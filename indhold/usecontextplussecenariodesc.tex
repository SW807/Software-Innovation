...
Systemet kører på en smartphone der kan bruges til at assistere patienter ved at fortælle dem hvis der er en forværring i deres tilstand, eksempelvis i form af vibration eller afspille en lyd.
\lars{ARGH satan, ved ikke om dette kan blive til noget fornuftigt.}

\subsection{Problems}
Af potentielle problemer, der kunne være er at smartphone for ofte befinder sig i en kontekst hvor den indsamlede data ikke kan bruges, hvilket vil kræve en ændring.
...
For det andet sæt af scenarier hvor patienten går ind og ser sin tilstand, er der også noget, som kan kræve ændring.
